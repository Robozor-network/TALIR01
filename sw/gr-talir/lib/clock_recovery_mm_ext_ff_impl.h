...
#ifndef INCLUDED_TALIR_CLOCK_RECOVERY_MM_EXT_FF_IMPL_H
#define INCLUDED_TALIR_CLOCK_RECOVERY_MM_EXT_FF_IMPL_H
...
class clock_recovery_mm_ext_ff_impl : public clock_recovery_mm_ext_ff
{
public:
    clock_recovery_mm_ext_ff_impl(float omega,
                              float gain_omega,
                              float mu,
                              float gain_mu,
                              float omega_relative_limi,
                              int extra_channels);
    ~clock_recovery_mm_ext_ff_impl();
...
private:
    ...
    int d_extra_channels;
};

} /* namespace talir */
} /* namespace gr */

#endif /* INCLUDED_TALIR_CLOCK_RECOVERY_MM_EXT_FF_IMPL_H */
