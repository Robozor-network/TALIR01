...
let
  nixpkgs-moinmoin = import (builtins.fetchTarball {
    url = "https://github.com/NixOS/nixpkgs/archive/29b6ad6278dafcea4cac2e82c0f996b67f074dfc.tar.gz";
    # sha256:0lkxj9pkzwxbihn3j5nyk61814m5kshpziagdzicxlns1gn1295i
    sha256 = "0kg6x5xikaw3n1mhhamrrmc6xw77da8g6mlj7hvzvdnvdbiys1i9";
  }) { 
    config.allowUnfree = true;
  };
  cfg = config.services.moinmoin2;
  python = nixpkgs-moinmoin.python27;
...
in
{
  options.services.moinmoin2 = with types; {
